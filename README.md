...
> *We all know the local server is definitely faster, but we just want to make it more fun! and of course you would like to hug your API with 50000 requests per second* 🥰
